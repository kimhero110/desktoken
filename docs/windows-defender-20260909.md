...
2026-09-09，用户实际运行本地 beta.3 测试包，确认启动不再闪黑窗、未被 Defender 拦截。该包基于 8f861f5 并覆盖 Tauri 打包版本，扫描情报为 1.459.111.0。公开 beta.3 附件由标签重新构建，另有哈希，不能将本地扫描直接归于 CI 文件。新钩子的真实桌面全流程仍待验收，版本保持预发布；不撤销原 beta.2 检测提示。

## Microsoft 提交回执

已在 WDSI 回执页核对提交编号 653e1786-6bd8-483b-8bb9-14dd2db70e18，状态 Submitted，页面提交时间 Sep 9, 2026 01:47:09；截至 2026-09-09 核对时尚无分析员结论。提交对象是原 beta.2 安装包，附受影响便携版哈希和脱敏描述，不是 beta.3 新构建。回执受账号访问控制，不公开登录邮箱。
